 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_fc')){
	function azrcrv_create_plugin_menu_fc(){
		azrcrv_create_plugin_menu_table_fc();
		azrcrv_populate_plugin_menu_table_fc();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_fc')){
	function azrcrv_populate_plugin_menu_table_fc(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_fc')){
	function azrcrv_create_plugin_menu_table_fc(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
