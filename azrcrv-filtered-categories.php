...
const PLUGIN_NAME       = 'Filtered Categories';
const PLUGIN_SHORT_SLUG = 'filtered-categories';
const PLUGIN_SLUG       = 'azrcrv-filtered-categories';
const PLUGIN_HYPHEN     = 'azrcrv-fc';
const PLUGIN_UNDERSCORE = 'azrcrv_fc';
